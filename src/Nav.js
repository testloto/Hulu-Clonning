...
function Nav({setSelectedOption}) {
  return (
    <div className="nav">
      ...
      <h2 onClick={() => setSelectedOption(requests.fectchTopRated)}>Top Rated</h2>
      <h2 onClick={() => setSelectedOption(requests.fetchActionMovies)}>Action</h2>
      <h2 onClick={() => setSelectedOption(requests.fetchComdeyMovies)}>Comedy</h2>
      <h2 onClick={() => setSelectedOption(requests.fetchHorrorMovie)}>Horror</h2>
      <h2 onClick={() => setSelectedOption(requests.fetchRomanticMovie)}>Romance</h2>
